...
class AEUploadBox extends RDPagObj {
    
    function AEUploadBox($diretorioAtual="") {
      ...
      //faz um refresh no frame da esquerda
        ...
        $this->add("<table background=\"$urlimagens/bg_cinza.gif\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\">");
        $this->add("<tr>");
