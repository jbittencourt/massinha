...
$pag->add("<img src=\"$urlimlang/img_tit_mensagens_enviar.gif\"><br>");
$pag->add("<table border=0 cellspacing=0 cellpadding=0 width=\"100%\">");
$pag->add("<tr><td class=\"tdblue\">");
...
$win = new RDJSWindow("$urlferramentas/agenda/procura.php?acao_pertinente=correio",$lang[livro_enderecos],600,400);
$link2 = $win->getScript();
...
$a = "<tr><td valign=top width=\"30%\" align=right class=\"comum\">";
