 ...
 * Last Modified..: $Date: 2003/07/25 02:18:22 $
...
function dynCalendar_show()
{
  ...
  monthnames = new Array(<? echo "'$lang[january]','$lang[february]','$lang[march]','$lang[april]','$lang[may]','$lang[june]','$lang[july]','$lang[august]','$lang[september]','$lang[october]','$lang[november]','$lang[december]'"; ?>);
  ...
  prevImgHTML  = '<img src="<? echo "$urlimagens/".$config_ini[SmartForm][calendar_left];?>" alt="<<" border="0" />';
  prevLinkHTML = '<a href="javascript: ' + this.objName + '.show(' + previousMonth + ', ' + previousYear + ')">' + prevImgHTML + '</a>';
  nextImgHTML  = '<img src="<? echo "$urlimagens/".$config_ini[SmartForm][calendar_right];?>" alt=">>" border="0" />';
  ...
  html += '<tr>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[sun]";?></td>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[mon]";?></td>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[tue]";?></td>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[wed]";?></td>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[thu]";?></td>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[fri]";?></td>';
  html += '<td class="dynCalendar_dayname"><? echo "$lang[sat]";?></td></tr>';
  html += '<tr>' + ret.join('</tr>\n<tr>') + '</tr>';
  html += '</table>';
...
function dynCalendar_writeHTML()
{
  if (is_ie5up || is_nav6up || is_gecko) {
    document.write('<a href="javascript: ' + this.objName + '.show()"><img src="<?echo $urlimagens."/".$config_ini[SmartForm][calendar_image]; ?>" border="0" width="16" height="16" /></a>');
