...
//
// $Id: htmlarea.js,v 1.2 2004/05/06 18:49:05 juliano Exp $


if (typeof _editor_url_js == "string") {
	// Leave exactly one backslash at the end of _editor_url
	//_editor_url_js = _editor_url_js.replace(/\x2f*$/);
} else {
...
(function() {
	...
	var scripts = HTMLArea._scripts = [ _editor_url_js + "htmlarea.js",
					    _editor_url_js + "dialog.js",
					    _editor_url_js + "popupwin.js",
					    _editor_url_js + _editor_lang + ".js" ];
...
HTMLArea.Config = function () {
	...
	for (var i in this.btnList) {
		...
		btn[1] = _editor_url_images + btn[1];
...
HTMLArea.loadPlugin = function(pluginName) {
	var dir = _editor_url_js;
	var plugin = pluginName.replace(/([a-z])([A-Z])([a-z])/g,
					function (str, l1, l2, l3) {
						return l1 + "-" + l2.toLowerCase() + l3;
					}).toLowerCase() ;
	var plugin_file = dir + plugin + ".js";
	var plugin_lang = dir + plugin + "." + HTMLArea.I18N.lang + ".js";
...
HTMLArea.loadStyle(_editor_url_css+"htmlarea.css");
